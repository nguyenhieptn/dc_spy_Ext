let Fineartamerica = class {
	...
	getProducts(callback) {
		...
		let products = [];
		document.querySelectorAll("#searchEngineResultsParentDiv .searchengineresultdiv").forEach((el) => {
				let title = el.querySelector(".imageTitle").innerText;
				if (el.querySelector(".imageTitle")) {
